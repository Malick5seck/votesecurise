...
export default function Accueil() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-fondSombre transition-colors duration-300 overflow-hidden">
            ...
            {/* 🔥 RESPONSIVE : py-16 sur mobile, py-24 sur PC */}
            <div className={`bg-[#3b82f6] dark:bg-blue-900 text-white py-16 sm:py-24 px-4 text-center transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 tracking-tight leading-tight">
                        Bienvenue sur notre plateforme de sondages sécurisés.
                    </h1>
                    
                    <p className="text-base sm:text-lg md:text-xl mb-8 sm:mb-10 text-blue-100 max-w-2xl mx-auto leading-relaxed px-2">
                        Exprimez-vous en toute confiance, votre vote est unique et protégé. Collectez des avis, analysez les résultats en temps réel et partagez vos sondages facilement.
                    </p>
                    
                    {/* 🔥 RESPONSIVE : w-full sur mobile pour un clic facile au pouce */}
                    <button 
                        onClick={handleCreerSondageClick}
                        className="w-full sm:w-auto bg-white text-[#3b82f6] dark:text-blue-900 font-bold py-3.5 sm:py-3 px-8 rounded-xl shadow hover:bg-gray-100 hover:shadow-lg transition-all duration-300 inline-flex justify-center items-center hover:-translate-y-1"
                    >
                        Créer un sondage <span className="ml-2 text-xl">→</span>
                    </button>
                </div>
            ...
            <div className={`bg-white dark:bg-carteSombre py-12 sm:py-16 px-4 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <div className="container mx-auto max-w-6xl">
                    {/* 🔥 RESPONSIVE : gap-5 sur mobile pour ne pas trop espacer les blocs empilés */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
                        
                        <div className="text-center p-6 bg-gray-50 dark:bg-fondSombre rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">Rapide</h3>
                        ...
                        <div className="text-center p-6 bg-gray-50 dark:bg-fondSombre rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">Sécurisé</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                                Anti-double vote intégré et authentification sécurisée.
                            </p>
                        </div>
                        ...
                        <div className="text-center p-6 bg-gray-50 dark:bg-fondSombre rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">Analytique</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                                Résultats en temps réel avec graphiques et export PDF.
                            </p>
                        </div>
            ...
            <div className={`container mx-auto py-12 sm:py-16 px-4 max-w-7xl transition-all duration-1000 delay-500 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <div className="text-center mb-10 sm:mb-12">
                    <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-800 dark:text-white mb-3">
