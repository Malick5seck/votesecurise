...
//     return (
//         // 🔥 CORRECTION ICI : Ajout de px-4 sm:px-6 md:px-8 pour les marges mobiles
//         <div className={`max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 text-gray-800 dark:text-gray-200 transition-all duration-700 ease-out transform ${pageChargee ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
//             <div className="mb-6">
...
//                 <div className="bg-white dark:bg-carteSombre p-4 sm:p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mb-8">
//                     <div className="mb-5">
...
//                     <div className="flex flex-col sm:flex-row flex-wrap sm:items-center gap-6 sm:gap-8 mb-4">
//                         <div>
//                             <label className="block text-sm font-semibold mb-2">Date d'expiration</label>
//                             {/* 🔥 CORRECTION ICI : w-full sur mobile, w-48 sur grand écran */}
//                             <input type="date" value={dateFin} onChange={(e) => setDateFin(e.target.value)} className="w-full sm:w-48 p-2.5 bg-gray-50/50 dark:bg-fondSombre border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm text-gray-500 dark:text-white" />
//                         </div>
...
//                     {!estPublic && (
//                         <div className="mt-6 p-4 sm:p-5 bg-orange-50 dark:bg-orange-900/20 rounded-xl border border-orange-200 dark:border-orange-800 animate-fade-in">
//                             <h3 className="font-bold text-orange-800 dark:text-orange-400 mb-2 flex items-center gap-2">
//                                 <span>🛡️</span> Restrictions d'accès 
//                             </h3>
...
//                                 </div>
//                                 <div>
//                                     <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Ou créer une liste blanche </label>
...
//                     <button type="submit" disabled={chargement} className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-[#3b82f6] hover:bg-blue-700 text-white rounded-lg font-medium text-sm transition-colors disabled:opacity-50">{chargement ? 'Création...' : 'Créer le sondage'}</button>
//                 </div>
//             </form>
//         </div>
//     );
...
export default function CreerSondage({ onSondageCree }) {
    ...
    return (
        // max-w-full overflow-x-hidden empêche tout scroll horizontal non désiré
        <div className={`w-full max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 text-gray-800 dark:text-gray-200 transition-all duration-700 ease-out transform overflow-x-hidden ${pageChargee ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="mb-6">
