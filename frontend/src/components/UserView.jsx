...
export default function UserView({
    ...
    if (vueActuelle === 'mes-sondages') {
        ...
        return (
            <div className="bg-white dark:bg-carteSombre p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 animate-fade-in">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 border-b border-gray-100 dark:border-gray-800 pb-6">
                    ...
                    <Link to="/creer" className="bg-[#3b82f6] hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-xl transition-all transform hover:-translate-y-0.5 hover:shadow-lg shadow-blue-500/30 flex items-center gap-2">
                    ...
                    <div>
                        <div className="space-y-4">
                            {sondagesAffiches.map((sondage) => (
                                // 🔥 NOUVELLES ANIMATIONS DE SURVOL SUR LA CARTE DU SONDAGE
                                <div 
                                    key={sondage.id} 
                                    className="group flex flex-col md:flex-row justify-between items-center bg-gray-50/50 dark:bg-fondSombre p-5 rounded-xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-[#3b82f6]/40 hover:-translate-y-1"
                                >
                                    <div className="mb-5 md:mb-0 w-full md:w-1/2">
                                        <h5 className="font-extrabold text-lg text-gray-900 dark:text-white flex items-center flex-wrap gap-2 group-hover:text-[#3b82f6] transition-colors">
                                            {sondage.titre}
                                    ...
                                    <div className="flex flex-wrap gap-3 w-full md:w-auto justify-end">
                                        <button 
                                            ...
                                            className="flex items-center gap-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 hover:border-[#3b82f6] hover:text-[#3b82f6] font-bold py-2 px-4 rounded-lg shadow-sm text-sm text-gray-700 dark:text-gray-300 transition-all transform hover:-translate-y-0.5 hover:shadow-md"
                                        >
                                        ...
                                        <Link 
                                            ...
                                            className="flex items-center gap-1.5 bg-blue-50 dark:bg-blue-900/20 text-[#3b82f6] dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/40 font-bold py-2 px-4 rounded-lg shadow-sm text-sm transition-all transform hover:-translate-y-0.5 hover:shadow-md"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                                        ...
                                        <button 
                                            ...
                                            className="flex items-center gap-1.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40 font-bold py-2 px-4 rounded-lg shadow-sm text-sm transition-all transform hover:-translate-y-0.5 hover:shadow-md"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="bg-white dark:bg-carteSombre p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                            ...
                            <form onSubmit={handleUpdateProfile} className="space-y-5">
                                ...
                                <button type="submit" disabled={loadingProfil} className="w-full bg-[#3b82f6] hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-blue-500/30 hover:-translate-y-0.5">Enregistrer</button>
                            </form>
                        </div>
                        ...
                        <div className="bg-white dark:bg-carteSombre p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                            ...
                            <form onSubmit={handleUpdatePassword} className="space-y-5">
                                ...
                                <button type="submit" disabled={loadingProfil} className="w-full bg-gray-900 dark:bg-gray-700 text-white font-bold py-4 rounded-xl hover:bg-gray-800 transition-all shadow-lg hover:-translate-y-0.5">Changer le mot de passe</button>
                            </form>
                        </div>
                    </div>
                        ...
                        {mesSondages.length > 0 && (
                            <div className="bg-white dark:bg-carteSombre p-8 rounded-2xl shadow-xl border border-blue-100 dark:border-blue-900/30">
                                ...
                                <div className="grid grid-cols-3 gap-6 text-center">
                                    <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-2xl border border-blue-100 dark:border-blue-800/30 transform transition-all hover:scale-105"><p className="text-xs text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider mb-2">Créés</p><p className="text-4xl font-extrabold text-[#3b82f6]">{mesSondages.length}</p></div>
                                    <div className="bg-emerald-50 dark:bg-emerald-900/20 p-5 rounded-2xl border border-emerald-100 dark:border-emerald-800/30 transform transition-all hover:scale-105"><p className="text-xs text-emerald-600 dark:text-emerald-400 font-bold uppercase tracking-wider mb-2">Reçus</p><p className="text-4xl font-extrabold text-emerald-500">{totalVotesRecus}</p></div>
                                    <div className="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-2xl border border-purple-100 dark:border-purple-800/30 transform transition-all hover:scale-105"><p className="text-xs text-purple-600 dark:text-purple-400 font-bold uppercase tracking-wider mb-2">Participation</p><p className="text-2xl font-extrabold text-purple-500 mt-2">{tauxParticipation} <span className="text-sm font-normal">/sondage</span></p></div>
                                </div>
                            </div>
                        )}
                        
                        {/* HISTORIQUE DES VOTES AVEC EFFET HOVER */}
                        <div className="bg-white dark:bg-carteSombre p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                            ...
                            <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                {historiqueVotes.length === 0 ? (
                                    ...
                                    historiqueVotes.map(vote => (
                                        <div key={vote.id} className="group bg-gray-50/50 dark:bg-fondSombre p-5 rounded-xl border border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between gap-4 transition-all duration-300 hover:shadow-md hover:border-[#3b82f6]/30 hover:-translate-y-0.5">
                                            <div>
                                                <p className="font-bold text-gray-900 dark:text-white group-hover:text-[#3b82f6] transition-colors">{vote.sondage ? vote.sondage.titre : "Sondage supprimé"}</p>
                                            ...
                                            {vote.sondage && (
                                                <Link to={`/sondage/${vote.sondage.id}/resultats`} className="inline-flex items-center gap-1 text-[#3b82f6] hover:text-blue-800 dark:hover:text-blue-300 font-bold text-sm transition-colors">
                                                    Voir les résultats
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4 transform group-hover:translate-x-1 transition-transform"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" /></svg>
                                                </Link>
                                            )}
                                        </div>
                                    ))
