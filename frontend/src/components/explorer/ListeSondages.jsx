...
//     return (
//         <div ref={listeRef} className="space-y-8 sm:space-y-10 animate-fade-in px-4 sm:px-0">
...
//                     <div className="w-full sm:w-auto flex flex-col sm:flex-row items-center gap-3 sm:gap-4 bg-gray-50 dark:bg-fondSombre p-3 sm:p-2 rounded-xl sm:rounded-full border border-gray-100 dark:border-gray-800 shadow-sm">
//                         <button 
